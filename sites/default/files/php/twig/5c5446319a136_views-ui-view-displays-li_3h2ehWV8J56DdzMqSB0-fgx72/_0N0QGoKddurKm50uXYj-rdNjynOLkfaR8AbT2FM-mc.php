  ...
  ";
      ...
      ";
            ...
            if ($this->getAttribute($context["display"], "path", [])) {
                // line 16
                echo "        ";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["display"], "display", []), "html", null, true));
                echo " <span data-drupal-selector=\"views-table-filter-text-source\">(";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["display"], "path", []), "html", null, true));
                echo ")</span>
      ";
            } else {
                // line 18
...
", "core/themes/stable/templates/admin/views-ui-view-displays-list.html.twig", "/var/www/html/drupalTrainingProject/core/themes/stable/templates/admin/views-ui-view-displays-list.html.twig");
    }
}
